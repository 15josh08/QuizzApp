...
import com.Josh.QuizApp.dao.QuizDao;
import com.Josh.QuizApp.support.Question;
import com.Josh.QuizApp.support.QuestionWrapper;
import com.Josh.QuizApp.support.Quiz;
import com.Josh.QuizApp.support.Response;
...
public class QuizService {
	...
	public ResponseEntity<Integer> calculateResult(Integer id, List<Response> responses) {
		...
		int correct = 0;
		int i = 0;
		for(Response responses1 : responses) {
